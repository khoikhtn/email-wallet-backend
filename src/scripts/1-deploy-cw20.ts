...
import instantiate_args from "../../input_arguments/instantiate_args.json";
import mint_cw20_args from "../../input_arguments/mint_args.json";

const contractWasmPath = process.env.CONTRACT_PATH;
